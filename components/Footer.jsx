  ...
  return (
    <footer className="text-black dark:text-gray-300 border-t border-gray-200 dark:border-gray-800 pt-14 pb-10 px-4 md:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
        ...
        <div className="col-span-1">
          <div className="flex items-center gap-2 mb-4">
            <img src="/skill.png" alt="zoolana Logo" className="h-6 w-auto" />
        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            <a
              href="https://github.com/dagmfre/zoolana"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/dagmfre-seid-51a094214"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
            >
      ...
      <div className="text-center text-gray-500 dark:text-gray-400 text-xs mt-10">
        © {new Date().getFullYear()} zoolana. Built with 💡 by Dagmfre.
      </div>
    </footer>
  );
}
