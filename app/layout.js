...
export const metadata = {
  title: "zoolana - Your AI-Powered Career Assistant",
  description:
    ...
    <ClerkProvider appearance={{ baseTheme: dark }}>
      <html lang="en" suppressHydrationWarning className="dark">
        <head>
          ...
          />
          <meta name="author" content="zoolana" />
          ...
          <meta property="og:url" content="https://zoolana.com" />
          <meta property="og:image" content="https://zoolana.com/og-image.png" />

          {/* Twitter Card Meta Tags */}
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content={metadata.title} />
          <meta name="twitter:description" content={metadata.description} />
          <meta name="twitter:image" content="https://zoolana.com/og-image.png" />
        </head>
